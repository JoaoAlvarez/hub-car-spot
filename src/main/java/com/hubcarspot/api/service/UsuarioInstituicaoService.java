...
public class UsuarioInstituicaoService {
    ...
    public List<UsuarioInstituicao> findAll() {
        ...
        Optional<UsuarioInstituicao> ui = usuarioInstituicaoRepository.findById(user);
        if (!ui.isPresent()) {
            return new ArrayList<>();
        }
        return usuarioInstituicaoRepository.findByInstituicaoId(ui.get().getInstituicao());
    }
