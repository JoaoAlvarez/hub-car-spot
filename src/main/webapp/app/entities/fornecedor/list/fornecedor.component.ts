...
import { EntityArrayResponseType, FornecedorService } from '../service/fornecedor.service';
...
export class FornecedorComponent implements OnInit {
  ...
  trackId = (_index: number, item: IFornecedor): string => this.fornecedorService.getFornecedorIdentifier(item);
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.fornecedors = dataFromBody;
  }

  protected fillComponentAttributesFromResponseBody(data: IFornecedor[] | null): IFornecedor[] {
    return data ?? [];
  }
  ...
  protected queryBackend(): Observable<EntityArrayResponseType> {
    ...
    return this.fornecedorService.query(queryObject).pipe(tap(() => (this.isLoading = false)));
  }
